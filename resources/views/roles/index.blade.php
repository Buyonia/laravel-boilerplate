                            ...
                            <table class="table text-center"
                                ...
                                <tr>
                                    ...
                                    <th onclick="sortTable(1)"
                                        class="cursor-pointer">Role
                                                               Name<i data-feather="arrow-up"></i><i data-feather="arrow-down"></i>
                                    </th>
                                    <th>Status</th>
                                    <th>Actions</th>
                                </tr>
                                @foreach($all_roles as $index=>$users)
                                    <tr>
                                        <td>{{$index+$all_roles->firstItem()}}</td>
                                        <td>{{$users->name}}</td>
                                            ...
                                            <div class="btn-group"
                                                ...
                                                @if($users->deleted_at != null)
                                                    ...
                                                    <a class="text-success mr-2"
                                                       href="{{ route('role.restore',$users->id) }}"
                                                       data-toggle="tooltip"
                                                       data-placement="top"
                                                       title="Restore"><i data-feather="refresh-cw"></i></a>
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                ...
                                                                                                <a class="btn btn-danger mr-2"
                                                                                                   href="{{ route('role.forceDelete',$users->id) }}"
                                                                                                   data-toggle="tooltip"
                                                                                                   data-placement="top"
                                                                                                   title="Force Delete">Delete</a>
                                                ...
                                                @else
                                                    <a class="text-primary mr-2"
                                                       href="{{ route('assign.permissionFrom',$users->id) }}"
                                                       data-toggle="tooltip"
                                                       data-placement="top"
                                                       title="Permission"><i data-feather="shield"></i></a>
                                                    <a class="text-success mr-2"
                                                       href="{{ route('role.edit',$users->id) }}"
                                                       data-toggle="tooltip"
                                                       data-placement="top"
                                                       title="Edit"><i data-feather="edit"></i></a>

                                                    <form action="{{ route('role.destroy',$users->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
