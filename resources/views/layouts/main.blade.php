...
<nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow mt-0">
    ...
    <span class="nav navbar-nav align-items-center mt-1 mr-1 p-0">
        ...
        <span class="nav-item dropdown dropdown-user p-0"><a class="nav-link dropdown-toggle dropdown-user-link p-0"
                                                        id="dropdown-user" href="javascript:void(0);"
                                                        data-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="false">
                <div class="user-nav d-sm-flex d-none p-0"><span
                        class="user-name font-weight-bolder  bg-light-success p-1 rounded">{{ Auth::user()->name  }} <i class="fa fa-angle-down"></i></span></div>
    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('/home') }}"><span
                        ...
                        </span> <h2 class="brand-text">{{$existing_setting->name}}</h2>
                </a></li>
